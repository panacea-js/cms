...
.GraphiqlVoyagerLogo
  ...
  &__image
    ...
    margin-left -10px
    :root .theme--dark & path
      fill white

    :root .theme--light & path
      fill rgba(0, 0, 0, .87)
