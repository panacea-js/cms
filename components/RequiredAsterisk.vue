<template>
  <span :class="classes()">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 24.748 24.748" style="enable-background:new 0 0 24.748 24.748;" xml:space="preserve">
      <g>
...
export default {
  methods: {
    classes() {
      ...
      if (this.type) {
        classes.push(`RequiredAsterisk--${this.type}`)
      }
      return classes
    }
  },
...
.RequiredAsterisk
  ...
  svg path
    fill: $red.base
  &--form-element
    transform translateY(1.5rem) translateX(-2.3rem)
    position: absolute
</style>